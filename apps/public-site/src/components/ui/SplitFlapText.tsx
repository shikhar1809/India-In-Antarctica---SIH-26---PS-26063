...
const SplitFlapText = ({
  ...
  const phrasesKey = typeof text === 'string' && text !== '' ? text : sourceWords.map(word => String(word ?? '')).join('\u001f');
  ...
  }, [isInView, normalizedPhrases, width, loop, cycleDelay, flipDuration, stagger, flipsPerChar, charset, prefersReducedMotion]);
