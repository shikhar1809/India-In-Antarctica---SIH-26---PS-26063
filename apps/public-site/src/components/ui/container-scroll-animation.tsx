...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[44rem] md:h-[58rem] flex items-center justify-center relative p-2 md:p-10"
      ref={containerRef}
    >
...
export const Card = ({
  ...
  <motion.div
    ...
    className="max-w-5xl -mt-8 mx-auto h-[24rem] md:h-[34rem] w-full border-4 border-[#6C6C6C] p-2 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl"
  >
