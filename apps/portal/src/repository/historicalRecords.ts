...
export const HISTORICAL_RECORDS: RepositoryRecord[] = [
  {
      ...
      },
      {
        ...
        "figure": {
          ...
          "rows": [
            {
              "label": "Expedition",
              "value": "Third Indian Scientific Expedition to Antarctica"
            },
            {
              "label": "Season",
              "value": "1983–84"
            ...
            {
              "label": "Foundation",
              "value": "Ice shelf, Princess Astrid Coast"
            },
            {
              "label": "Wintering capacity",
              "value": "Year-round party"
            },
            {
              "label": "Decommissioned",
              "value": "Early 1990s — snow accumulation"
            },
            {
              "label": "Status today",
              "value": "Supply base and transit point"
            }
          ]
        }
      }
    ...
    "references": [
      {
        "citation": "National Centre for Polar and Ocean Research — Indian Antarctic Programme",
        "url": "https://ncpor.res.in"
      },
      {
        "citation": "Ministry of Earth Sciences — Antarctic and Southern Ocean research",
        "url": "https://moes.gov.in"
      }
    ],
    "photoUrls": [
      "/photos/dakshin-aerial.jpg",
      "/photos/icebreaker.jpg"
    ],
    "videoUrl": null,
    "measurements": [],
    "metadata": {
  ...
  },
  {
      ...
      },
      {
        ...
        "figure": {
          ...
          "rows": [
            {
              "label": "Expedition",
              "value": "Eighth Indian Scientific Expedition to Antarctica"
            },
            {
              "label": "Commissioned",
              "value": "1989"
            ...
            {
              "label": "Location",
              "value": "Schirmacher Oasis, Queen Maud Land"
            },
            {
              "label": "Foundation",
              "value": "Exposed rock and moraine"
            },
            {
              "label": "Construction",
              "value": "Approximately 45 days"
            },
            {
              "label": "Status",
              "value": "Operational, year-round"
            }
          ]
        }
      }
    ...
    "references": [
      {
        "citation": "National Centre for Polar and Ocean Research — Maitri station",
        "url": "https://ncpor.res.in"
      },
      {
        "citation": "Scientific Committee on Antarctic Research",
        "url": "https://www.scar.org"
      }
    ],
    "photoUrls": [
      "/photos/maitri-aerial.jpg",
      "/photos/maitri-flag.jpg"
    ],
    "videoUrl": null,
    "measurements": [],
    "metadata": {
  ...
  },
  {
      ...
      },
      {
        ...
        "figure": {
          ...
          "rows": [
            ...
            {
              "label": "Location",
              "value": "Larsemann Hills, Prydz Bay"
            },
            {
              "label": "Construction",
              "value": "134 prefabricated containers"
            },
            {
              "label": "Seasons to build",
              "value": "Two austral summers"
            },
            {
              "label": "Status",
              "value": "Operational, year-round"
    ...
    "references": [
      {
        "citation": "National Centre for Polar and Ocean Research — Bharati station",
        "url": "https://ncpor.res.in"
      },
      {
        "citation": "Antarctic Treaty Secretariat — Larsemann Hills Antarctic Specially Managed Area",
        "url": "https://www.ats.aq"
      }
    ],
    "photoUrls": [
      "/photos/bharati-station.jpg"
    ],
    "videoUrl": null,
    "measurements": [],
    "metadata": {
  ...
  },
  {
    ...
    "references": [
      {
        "citation": "National Centre for Polar and Ocean Research — Schirmacher Oasis",
        "url": "https://ncpor.res.in"
      }
    ],
    "photoUrls": [
      "/photos/lake-priyadarshini.jpg",
      "/photos/aurora-panorama.jpg"
    ],
    "videoUrl": null,
    "measurements": [],
    "metadata": {
  ...
  },
  {
    ...
    "table": [
      {
        "label": "Instrument",
        "value": "Brewer MKIV spectrophotometer #153"
      },
      {
      ...
      {
        "label": "Measured by",
        "value": "India Meteorological Department"
      },
      {
        "label": "Archived by",
        "value": "WOUDC (WMO / GAW), station 400"
      },
      {
        "label": "Licence",
        "value": "Free and unrestricted, with attribution"
      }
    ],
      ...
      "columns": [
        {
          ...
          "unit": null,
          "type": "datetime",
          "description": "Observation day, UTC."
        },
        {
          "name": "column_o3_du",
          "unit": "DU",
          "type": "number",
          "description": "Total column ozone in Dobson Units."
        },
        {
          "name": "column_so2_du",
          "unit": "DU",
          "type": "number",
          "description": "Total column sulphur dioxide, retrieved alongside ozone."
        },
        {
          "name": "n_observations",
          "unit": null,
          "type": "number",
          "description": "Individual observations the daily value was computed from."
        },
        {
          "name": "wavelength_code",
          "unit": null,
          "type": "text",
          "description": "WOUDC wavelength-pair code used for the retrieval."
        },
        {
          "name": "observation_code",
          "unit": null,
          "type": "text",
          "description": "WOUDC observation-type code (direct sun, zenith sky)."
        },
        {
          "name": "instrument",
          "unit": null,
          "type": "text",
          "description": "Instrument make, model and serial number."
        }
      ],
      "sampleRows": [
        {
    ...
    "references": [
      {
        "citation": "World Ozone and Ultraviolet Radiation Data Centre (WOUDC) — Maitri, station 400. Data contributed by the India Meteorological Department.",
        "url": "https://woudc.org/en/data/stations/"
      },
      {
        "citation": "WOUDC data use policy — free and unrestricted use with attribution.",
        "url": "https://woudc.org/en/data/data-use-policy/"
      },
      {
        "citation": "WMO Global Atmosphere Watch Station Information System — Maitri (MTR).",
        "url": "https://gawsis.meteoswiss.ch/GAWSIS/index.html#/search/station/stationReportDetails/0-20008-0-MTR"
      },
      {
    ...
    "metadata": {
      ...
      "provenance": {
        ...
        "sourceId": "d1",
        "approvedBy": "NCPOR",
        "approvedAt": 915148800000
      }
    },
    "publishedAt": 915148800000
  },
  {
    "id": "historical-d2",
    "cat": "dataset",
    "kind": "Dataset",
    "title": "Ozone Vertical Profiles from Maitri, 1994–2011",
    "station": "maitri",
    "year": "1994–2011",
    "pills": [
      "Ozone",
    ...
    "table": [
      {
        "label": "Instrument",
        "value": "Indian ozonesonde, balloon-borne"
      },
      {
        "label": "Flights",
        "value": "143"
      ...
      {
        "label": "Period",
        "value": "8 Jan 1994 – 8 Nov 2011"
      },
      {
        "label": "Levels per flight",
        "value": "26 – 88"
      },
      {
        "label": "Measured by",
    ...
    "dataset": {
      ...
      "columns": [
        {
          "name": "flight_date_utc",
          "unit": null,
          "type": "datetime",
          "description": "Date of the flight the level belongs to, UTC."
        },
        {
          "name": "level_index",
          "unit": null,
          "type": "number",
          "description": "Position of the level within the flight, from the surface upward."
        },
        {
          "name": "pressure_hpa",
          "unit": "hPa",
          "type": "number",
          "description": "Atmospheric pressure at the level."
        },
        {
          "name": "temperature_c",
          "unit": "°C",
          "type": "number",
          "description": "Air temperature at the level."
        },
        {
          "name": "o3_partial_pressure_mpa",
          "unit": "mPa",
          "type": "number",
          "description": "Ozone partial pressure measured by the electrochemical cell."
        },
        {
          "name": "flight_total_o3_du",
          "unit": "DU",
          "type": "number",
          "description": "Total ozone integrated from the profile, where reported."
        },
        {
          "name": "correction_factor",
          "unit": null,
          "type": "number",
          "description": "Correction factor applied to the flight, where reported."
        }
      ],
      "sampleRows": [
        {
    ...
    "references": [
      {
        "citation": "World Ozone and Ultraviolet Radiation Data Centre (WOUDC) — ozonesonde records for Maitri, station 400. Data contributed by the India Meteorological Department.",
        "url": "https://woudc.org/en/data/stations/"
      },
      {
        "citation": "WOUDC data use policy — free and unrestricted use with attribution.",
    ...
    "photoUrls": [
      "/photos/field-camp.jpg"
    ],
    "videoUrl": null,
    "measurements": [],
    "metadata": {
      "identifier": "IIA-1994-9005",
      "creators": [
        {
          "name": "India Meteorological Department",
          "affiliation": "NCPOR, Ministry of Earth Sciences"
  ...
  },
  {
    ...
    "cat": "dataset",
    "kind": "Dataset",
    "title": "Aerosols at Maitri and Bharati, IPY 2007–08",
    "station": "bharati",
    "year": "2008",
    "pills": [
      "Aerosols",
    ...
    "table": [
      {
        "label": "Maitri",
        "value": "8,250 ± 2,870 ng/m³"
      },
      {
        "label": "Larsemann Hills",
        "value": "6,030 ± 1,330 ng/m³"
      },
      {
        "label": "Method",
        "value": "Quartz crystal microbalance / sun photometer"
      },
      {
        "label": "Period",
        "value": "5 Jan – 10 Mar 2008"
      },
      {
        "label": "Published by",
        "value": "PANGAEA"
      ...
      "columns": [
        {
          ...
          "unit": null,
          "type": "text",
          "description": "Event label for the measurement campaign."
        },
        {
          "name": "Station",
          "unit": null,
        ...
        },
        {
          ...
          "unit": null,
          "type": "text",
          "description": "Instrumentation used."
        },
        {
          "name": "Aerosols",
          "unit": "ng/m³",
    ...
    "references": [
      {
        "citation": "Chaubey, J P; Moorthy, K K; Babu, S S; Nair, V S (2011): Total mass concentration of aerosols in Maitri and Larsemann Hills Station, Antarctica. PANGAEA. CC BY 3.0.",
        "url": "https://doi.pangaea.de/10.1594/PANGAEA.808285"
      },
      {
        "citation": "Chaubey, J P et al. (2011): Aerosol total mass concentration and optical depth during IPY 2007-2008 at Maitri and Larsemann Hills Station.",
        "url": "https://doi.pangaea.de/10.1594/PANGAEA.808290"
      }
    ],
    "photoUrls": [
      "/photos/bharati-station.jpg"
    ...
    "measurements": [],
    "metadata": {
      "identifier": "IIA-2008-9006",
      "creators": [
        {
          "name": "Chaubey, Moorthy, Babu & Nair (2011)",
          "affiliation": "NCPOR, Ministry of Earth Sciences"
        }
      ],
      "publisher": "NCPOR",
      ...
      "provenance": {
        ...
        "sourceId": "d3",
        "approvedBy": "NCPOR",
        "approvedAt": 1199145600000
      }
    },
    "publishedAt": 1199145600000
  },
  {
    "id": "historical-p1",
    "cat": "publication",
    ...
    "references": [
      ...
      {
        "citation": "National Centre for Polar and Ocean Research — geoscience programme",
        "url": "https://ncpor.res.in"
      }
    ],
    "photoUrls": [],
  ...
  },
  {
    ...
    "references": [
      {
        "citation": "World Meteorological Organization — Antarctic observing programmes",
        "url": "https://public.wmo.int"
      },
      {
        "citation": "National Centre for Polar and Ocean Research — atmospheric sciences",
        "url": "https://ncpor.res.in"
      }
    ],
    "photoUrls": [],
  ...
  },
  {
        ...
        "figure": {
          ...
          "rows": [
            ...
            },
            {
              ...
              "value": "Maitri, Bharati"
            },
            {
              "label": "Arctic station",
              "value": "Himadri, Ny-Ålesund"
            },
            {
              "label": "Remit",
              "value": "Polar and Southern Ocean research, expeditions, data custody"
            }
          ]
        }
      }
    ...
    "references": [
      {
        "citation": "National Centre for Polar and Ocean Research",
        "url": "https://ncpor.res.in"
      },
      {
        "citation": "Ministry of Earth Sciences",
        "url": "https://moes.gov.in"
      }
    ],
    "photoUrls": [],
  ...
  },
  {
      ...
      },
      {
        ...
        "figure": {
          ...
          "rows": [
            {
              "label": "Cadence",
              "value": "One austral summer voyage per season"
            },
            {
              "label": "Vessel",
              "value": "Chartered ice-class ship"
            },
            {
              "label": "Carries out",
              "value": "Fuel, cargo, food, instruments, expedition members"
            },
            {
              "label": "Carries back",
              "value": "Samples, returning members, all removable waste"
            },
            {
              "label": "Collected underway",
              "value": "Oceanographic and meteorological transect data"
            }
          ]
        }
      }
    ...
    "references": [
      {
        "citation": "Protocol on Environmental Protection to the Antarctic Treaty",
        "url": "https://www.ats.aq"
      },
      {
        "citation": "National Centre for Polar and Ocean Research — logistics",
        "url": "https://ncpor.res.in"
      }
    ],
    "photoUrls": [
